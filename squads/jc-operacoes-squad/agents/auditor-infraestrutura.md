...
description: >
  Auditor de Infraestrutura da empresa. Faz inventário REAL do servidor comparando
  com a documentação. Verifica DNS, containers, portas, .env, credenciais, serviços
  parados e gaps entre o que está documentado e o que realmente existe.
  Use antes de qualquer trabalho de infraestrutura ou quando documentação pode estar desatualizada.
