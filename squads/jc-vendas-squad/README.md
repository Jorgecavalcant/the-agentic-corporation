# 💰 Departamento de Vendas JC — jc-vendas-squad

Departamento de Vendas virtual da **Tech 42 LTDA**.

**13 super-profissionais** organizados em duas frentes:
- **Núcleo de Vendas (6)** — ofertas, leads, conversão, retenção, análise de receita
- **Sub-squad de Negociação (7)** — preparação pré-call, assistência AO VIVO em viva-voz, redação de propostas e análise pós-negociação
...
### Núcleo de Vendas
```
*jc-vendas:oferta       → Criar ou melhorar ofertas e pricing
*jc-vendas:leads        → Geração e qualificação de leads
*jc-vendas:conversao    → Melhorar taxa de conversão e fechamento
*jc-vendas:retencao     → Reduzir churn e aumentar LTV
*jc-vendas:metricas     → MRR, ARR, LTV/CAC, cohort analysis
*jc-vendas:pricing      → Revisão estratégica de preços
*jc-vendas:pipeline     → Estruturar funil de vendas
...
|---|-------------|---------------|----------------------|
| 1 | **Diretor de Vendas** (jc-dir-vendas) | Orquestração + Estratégia | Hormozi, Grant Cardone, RevOps |
...
| 6 | **Redator de Propostas** | Contrapropostas, e-mails, WhatsApp com tom calibrado | DNA Cerbasi + ancoragem + reciprocidade |
| 7 | **Analista Pós-Negociação** | Avaliação, aprendizado, alimentação do dossiê | Curva de aprendizado Jorge |

### Documentação de apoio do sub-squad
